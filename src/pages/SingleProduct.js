          ...
          <div className="col-12">
            ...
            <div className="bg-white p-3">
              <p>
                ...
                quis aut tempore consequuntur ipsam, repudiandae impedit
                laudantium ut similique voluptatibus ex, soluta dolor mollitia
                ullam inventore? Tempora deserunt magnam non.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="reviews mt-4">
                  <div className="review">
                    ...
                    <p className="mt-3">
                      ...
                      Ex aut ipsa tempora dignissimos officiis pariatur modi
                      unde eum, quisquam aspernatur qui nisi inventore ipsum
                      repellat. Voluptatem, saepe possimus. Delectus, aliquid!
                    </p>
                  </div>
                </div>
              </div>
